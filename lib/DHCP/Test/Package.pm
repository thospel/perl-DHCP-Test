package DHCP::Test::Package;
# $HeadURL: xxx/lib/DHCP/Test/Package.pm $
# $Id: xxx $
...
$VERSION = "1.000";
$SUB_VERSION = "008";
$release_time = 1617059795;	## no critic (UselessNoCritic MagicNumbers)
%history = (
  'Changes' => {
    '1.000' => '1.000'
  },
...
=for stopwords DHCP::Test globals

=head1 NAME

DHCP::Test::Package - Version and history of DHCP::Test

=head1 SYNOPSIS

  use DHCP::Test::Package;

  $epoch_time = DHCP::Test::Package->release_time();

  $package_version = DHCP::Test::Package->VERSION;

  $min_package_version = DHCP::Test::Package::released($module, $module_version);
...
=item X<release_time>$epoch_time = DHCP::Test::Package->release_time()
...
=item X<VERSION>$package_version = DHCP::Test::Package->VERSION
...
=item X<released>$min_package_version = DHCP::Test::Package::released($module, $module_version)
